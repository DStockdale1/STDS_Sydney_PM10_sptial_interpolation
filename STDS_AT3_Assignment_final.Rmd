...
knitr::include_graphics("C:/Users/Declan/Documents/STDS Assignment 3/variogram_example.png")
```
...
chosen_date_hour_grid_sf <- chosen_date_hour_sf %>% 
  ...
  st_as_sfc() %>% 
  st_make_grid(
  cellsize = c(round(100/horizontal_distance,5), round(100/vertical_distance,5)), #horizontal, vertical  cellsize = c(0.05, 0.01)
  what = "centers"
  ) %>%
  st_as_sf() %>%
  cbind(., st_coordinates(.))
